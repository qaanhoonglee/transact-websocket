 ...
 */
public class BusinessView extends Composite implements WebSocketListener {

    // Constants
    private static final String HEADER_TITLE = "GWT WebSocket Client Business";
    ...
    private void sendMessage() {
        ...
        if (!message.isEmpty() && webSocketManager.isConnected()) {
            webSocketManager.sendChatMessage(message, "Manager");
